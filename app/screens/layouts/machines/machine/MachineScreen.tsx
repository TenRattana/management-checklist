...
const MachineGroupScreen = React.memo(() => {
    ...
    const customtableProps = useMemo(() => ({
        ...
        flexArr: responsive === "large" ? [0, 0, 1, 2, 2, 3, 1, 1, 1] : responsive === "medium" ? [0, 0, 1, 1.5, 1, 1.5, 1, 1, 1] : [0, 0, 1, 2, 2, 2, 1, 1, 1],
    ...
    return (
        <View id="container-machine" style={styles.container}>
            <View id="container-search" style={masterdataStyles.containerSearch}>
                <Text style={[masterdataStyles.textBold, styles.header]}>{`List ${state.Machine}` || "List"}</Text>
            </View>
