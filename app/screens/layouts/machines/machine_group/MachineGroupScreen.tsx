...
const MachineGroupScreen = React.memo(() => {
    ...
    const handleAction = useCallback(async (action?: string, item?: string) => {
        try {
            if (action === "editIndex") {
                const response = await axiosInstance.post("GroupMachine/GetGroupMachine", { GMachineID: item });
                ...
                const response = await axiosInstance.post(`GroupMachine/${endpoint}`, { GMachineID: item });
