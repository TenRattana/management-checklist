    ...
    const handleAction = useCallback(async (action?: string, item?: string) => {
        try {
            if (action === "editIndex") {
                ...
                const response = await axiosInstance.post("MatchCheckListOptions/GetMatchCheckListOption", { MCLOptionID: item });
                ...
                const response = await axiosInstance.post(`MatchCheckListOptions/${endpoint}`, { MCLOptionID: item });
