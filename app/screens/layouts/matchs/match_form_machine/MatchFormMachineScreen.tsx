    ...
    const handleAction = useCallback(async (action?: string, item?: string) => {
        try {
            if (action === "changeIndex") {
                ...
                const response = await axiosInstance.post("MatchFormMachines/GetMatchFormMachine", {
                    MachineID: item,
                });
                ...
                const response = await axiosInstance.post(`MatchFormMachines/${endpoint}`, { MachineID: item });
